...
const load = {
  password: () => import("../../src/server/security/password"),
  tokens: () => import("../../src/server/security/tokens"),
  redirect: () => import("../../src/server/http/redirect"),
  csrf: () => import("../../src/server/security/csrf"),
  altcha: () => import("../../src/server/security/altcha"),
};
